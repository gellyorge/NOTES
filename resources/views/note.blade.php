        ...
        <div class="card p-4">
            <div class="row">
                ...
                <div class="col text-end">
                    <a href="/editNote/{{Crypt::encrypt($note['id'])}}" class="btn btn-outline-secondary btn-sm mx-1"><i class="fa-regular fa-pen-to-square"></i></a>

                    <a href="/deleteNote/{{Crypt::encrypt($note['id'])}}" class="btn btn-outline-danger btn-sm mx-1"><i class="fa-regular fa-trash-can"></i></a>
                </div>
            </div>
            <hr>
